...
queries = ["Q3_c", "Q18_c", "Q20_s", "Q9_s", "Q5_c", "Q8_c", "Q18_c", "Q7_c"]
databases = ['0.25','0.5', '1', '2', '4', '8', '16']
epsilons = [0.25, 0.5, 1, 2, 4, 8, 16]

epsilons = [4]

Ts = [1, 1, 1, 1, 1024, 1024, 1024, 1024]
Cs = [10, 16, 15, 19, 7, 12, 16, 15]
	...
	for i in range(len(databases)):
		for j in range(len(queries)):
			...
			for epsilon in epsilons:
				cmd = "../../anaconda3/envs/test/bin/python " + cur_path + "../Code/SampleAndExploreUserQuery.py -D " + databases[i] + " -Q " + queries[j] + " -k " + str(k) + " -T " + str(Ts[j]) + " -C " + str(Cs[j]) + " -e " + str(epsilon) + " -d 0.00000001 -a " + str(a) 
